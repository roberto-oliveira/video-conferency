...
window.RTCMultiConnection = function (roomid, forceOptions) {
    ...
    function MultiPeers(connection) {
        ...
        connection.peersBackup = {}, connection.peers = {
            ...
            if (!connection.peers[remoteUserId]) return void(connection.enableLogs && console.error("This peer (" + remoteUserId + ") does not exist. Renegotiation skipped."));
    ...
    function PeerInitiator(config) {
        ...
        config.remoteSdp && config.remoteSdp.remotePeerSdpConstraints && config.remoteSdp.remotePeerSdpConstraints.isFirefoxOffered && (isFirefoxOffered = !0), localStreams.forEach(function (localStream) {
            config.remoteSdp && config.remoteSdp.remotePeerSdpConstraints && config.remoteSdp.remotePeerSdpConstraints.dontGetRemoteStream || config.dontAttachLocalStream || (localStream = connection.beforeAddingStream(localStream, self), localStream && (getLocalStreams().forEach && getLocalStreams().forEach(function (stream) {
        ...
        peer.addEventListener(remoteStreamAddEvent, function (event) {
            if (event) {
                ...
                streamToShare && (event.stream.isAudio = streamToShare.isAudio, event.stream.isVideo = streamToShare.isVideo, event.stream.isScreen = streamToShare.isScreen), event.stream.streamid = event.stream.id, !isFirefox && event.stream.stop || (event.stream.stop = function () {
                    var streamEndedEvent = "ended";
    ...
    "undefined" == typeof MediaStream && "undefined" != typeof webkitMediaStream && (MediaStream = webkitMediaStream), "undefined" != typeof MediaStream && ("getVideoTracks" in MediaStream.prototype || (MediaStream.prototype.getVideoTracks = function () {
        ...
        function () {
            ...
            var MediaStream = window.MediaStream;
            "undefined" == typeof MediaStream && "undefined" != typeof webkitMediaStream && (MediaStream = webkitMediaStream), "undefined" != typeof MediaStream ? DetectRTC.MediaStream = Object.keys(MediaStream.prototype) : DetectRTC.MediaStream = !1,
    ...
    var OnIceCandidateHandler = function () {
        ...
        IceServersHandler = function () {
            ...
            function getSTUNObj(stunStr) {
                var urlsParam = "urls";
                "undefined" != typeof isPluginRTC && (urlsParam = "url");
                var obj = {};
